...
sg.theme_background_color("#FF9797")  
sg.theme_text_element_background_color("#FF9797")  
...
layout = [
    ...
    [sg.Button("Hapus", button_color=("black", "orange")), sg.Button("Simpan", button_color=("black", "orange"))]
]
