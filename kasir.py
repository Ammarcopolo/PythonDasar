...
def totalbeli():
    ...
    hCILOK = int(pensil.get()) * 5000
    hTEPUNG = int(buku.get()) * 3000
    hCIMOL = int(penghapus.get()) * 6500
    hCIRENG = int(penggaris.get()) * 7000
...
def kembalian():
    ...
    if uang >= total:
        ...
        messagebox.showinfo(message='Kembalian kamu  {}'.format(str(kembalian)))
    else:
